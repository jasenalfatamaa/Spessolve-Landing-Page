      ...
      >
        ...
        >
            ...
            <div className="relative z-10">
                ...
                <button className="flex items-center gap-2 text-brand-500 text-sm font-bold uppercase tracking-widest hover:text-white transition-colors group/btn">
                   <span>Learn More</span>
                   <div className="transition-transform group-hover/btn:translate-x-1 group-hover/btn:-translate-y-1">
