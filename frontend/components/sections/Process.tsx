...
const steps = [
  ...
  { id: '02', title: 'The Blueprint', subtitle: 'Architecture & Strategy', description: 'Drafting the narrative arc. We engineer the critical path to ROI, defining technical stacks and user flows. Every plot point is calculated for maximum impact.' },
