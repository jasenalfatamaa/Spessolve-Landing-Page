...
const pillars = [
  ...
  },
  {
    ...
    description: "Beauty with purpose. We craft digital environments that captivate users instantly, turning passive visitors into loyal advocates through intuitive, emotive UI."
  },
  {
    icon: <PixelIconCode />,
      ...
      <Container>
        ...
        <div className="flex flex-col lg:flex-row gap-16 mb-32 relative z-10">
          ...
          <div className="lg:w-1/2 lg:pt-24">
            ...
            >
              SPESSOLV was founded on a singular premise: that true innovation requires the fusion of <span className="text-brand-500">rigorous strategy</span> and <span className="text-brand-500">relentless creativity</span>.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              <p>
                In an era of digital noise, clarity is power. This drive for clarity defines our core philosophy: <span className="text-brand-500 font-medium font-mono lowercase">make it ez</span>.
              </p>
              <p>
                To us, this means decoding complexity. We absorb the technical burden so you don't have to, simplifying the software lifecycle to remove friction and ambiguity. We treat "easy" not as a lack of depth, but as the ultimate sophistication—delivering intuitive, high-performance solutions where others offer confusion.
              </p>
              <p>
                We bridge the gap between abstract ambition and tangible reality. By combining elite craftsmanship with enterprise-grade engineering, we build products that don't just function—they define categories.
              </p>
            </motion.div>
          </div>
        </div>
