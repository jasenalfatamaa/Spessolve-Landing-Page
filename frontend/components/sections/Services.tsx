...
const services = [
  ...
  },
  {
    ...
    description: 'We build web and mobile applications using modern frameworks, focusing on performance and reliability.'
  },
  {
    icon: <PixelIconLayers />,
    title: 'Core Business Systems',
    description: 'Secure and scalable systems built to support essential business operations, designed with clear architecture and reliable performance to ensure long-term stability.'
  },
  {
