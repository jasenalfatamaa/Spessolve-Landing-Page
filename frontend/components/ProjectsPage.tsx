...
export const allProjects: Project[] = [
  {
    ...
    description: 'Comprehensive booking and management system for travel agencies.',
    fullDescription: 'A custom-built travel system designed to handle complex bookings, itinerary management, and customer relations for modern travel agencies. It streamlines transactions and provides a crisp, responsive user interface to ensure the best customer experience.',
    technologies: ["React", "Next.js", "TailwindCSS"],
    testimonial: "The system transformed how we handle peak season bookings. It's incredibly intuitive and robust.",
    clientRole: "Operations Director, SkyTravel HQ",
    impact: 'Seamless Booking',
    year: '2026',
    image: travelingImg,
  ...
  {
    id: 7,
    title: 'Garment Compro',
    category: 'Corporate / Profile',
    description: 'Professional corporate profile for garment manufacturing companies.',
    fullDescription: 'A sleek and modern company profile website built for the garment industry. It beautifully showcases product highlights, company history, and manufacturing capabilities to attract international B2B clients.',
    technologies: ["React", "Vite", "TailwindCSS"],
    testimonial: "Our international inquiries doubled after launching this new profile. The design perfectly reflects our manufacturing standards.",
    clientRole: "CEO, Nusantara Garment",
    impact: 'Global Reach',
    year: '2026',
    image: garmentImg,
    url: 'https://garment-compro.vercel.app'
  },
  {
    id: 4,
    title: 'ArchLinks',
